...
subcounties_shp = subcounties_shp[['ADM1_EN','ADM2_EN','geometry']]
# print(subcounties_shp)
...
subcounties_shp.to_csv('MERGED/Merged_Data_Subcounties.csv')
subcounties_shp.to_file('MERGED/Merged_Data_Subcounties.shp')
